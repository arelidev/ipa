                        ...
                        >
                            <div class="accordion single-clinic-inner" data-accordion data-allow-all-closed="true">
                                ...
                                <div class="accordion-content">
									...
									<?php if (!empty($email = $work_information['work_email'])) : ?>
                                        <div class="grid-x">
                                            <div class="cell small-2">
									...
									<?php endif; ?>
									<?php if (!empty($phone = $work_information['work_telephone'])) : ?>
                                        <div class="grid-x">
                                            <div class="cell small-2">
									...
									<?php endif; ?>
									<?php if (!empty($address = $address['address'])) : ?>
                                        <div class="grid-x">
                                            <div class="cell small-2">
                                                <i class="far fa-map-marker-alt fa-lg"></i>
                                            </div>
									...
									<?php endif; ?>
									<?php if (!empty($website = $work_information['customer_website'])) : ?>
                                        <div class="grid-x">
                                            <div class="cell small-2">
                                                <i class="far fa-external-link-alt fa-lg"></i>
                                            </div>
            ...
            <div class="small-12 medium-6 large-6 cell small-order-1 large-order-2 map-container">
                <div class="grid-x map-overlay-card">
                    <div class="medium-3 text-center">
                        <img width="35" src="<?= get_template_directory_uri(); ?>/assets/images/icon-map-clinic-gold.png" aria-hidden="false" alt="">
                        <br>
                        <span><?= __('Clinic', 'ipa'); ?></span>
                    </div>

                    <div class="medium-3 text-center">
                        <img width="35" src="<?= get_template_directory_uri(); ?>/assets/images/icon-map-fellowship-blue.png" aria-hidden="false" alt="">
                        <br>
                        <span><?= __('Fellow', 'ipa'); ?></span>
                    </div>

                    <div class="medium-3 text-center">
                        <img width="35" src="<?= get_template_directory_uri(); ?>/assets/images/icon-map-cfmt-gray.png" aria-hidden="false" alt="">
                        <br>
                        <span><?= __('CFMT', 'ipa'); ?></span>
                    </div>

                    <div class="medium-3 text-center">
                        <img width="35" src="<?= get_template_directory_uri(); ?>/assets/images/icon-map-multi-white.png" aria-hidden="false" alt="">
                        <br>
